...
namespace Cervantes.DAL.Migrations
{
    ...
    [Migration("20260611204801_AddTargetServiceCve")]
    partial class AddTargetServiceCve
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.TargetServiceCve", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("CveConfigurationId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TargetServiceId", "CveId")
                        .IsUnique();

                    b.ToTable("TargetServiceCves");
                });
            ...
            modelBuilder.Entity("Cervantes.CORE.Entities.TargetServiceCve", b =>
                {
                    b.HasOne("Cervantes.CORE.Entities.CveConfiguration", "CveConfiguration")
                        .WithMany()
                        .HasForeignKey("CveConfigurationId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("Cervantes.CORE.Entities.TargetServices", "TargetService")
                        .WithMany()
